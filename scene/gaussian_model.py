...
class GaussianModel:
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, *, N=2):
        ...
        self.densify_and_split_selected(selected_pts_mask, N=N)

    def densify_and_split_selected(self, selected_pts_mask, *, N=2):
        # print(f"Number of splitted points {torch.sum(selected_pts_mask)}")
    ...
    def densify_and_clone(self, grads: torch.Tensor, grad_threshold: float, scene_extent: float):
        ...
        self.densify_and_clone_selected(selected_pts_mask)

    def densify_and_clone_selected(self, selected_pts_mask: torch.Tensor):
    ...
    def densify_and_prune(self, max_grad: float, min_opacity: float, camera_extent, max_screen_size):
        ...
        self.densify_and_clone(grads, max_grad, camera_extent)
