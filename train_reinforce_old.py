...
def training(
    ...
    policy_optimizer = torch.optim.AdamW(action_selector.parameters(), lr=0.1)
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        for i, gaussians in enumerate(gaussian_candidate_list):
            ...
            gaussian_selection_rewards[i] = -loss.detach() #/ math.log(gaussians.num_points)
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                if iteration > opt.densify_from_iter and iteration % opt.densification_interval == 0:
                    if log_probability_candidates is not None:
                        ...
                        if True:
                            with torch.enable_grad():
                                ...
                                loss = -torch.mean(log_probability_candidates * advantage)
                                loss.backward()
                    ...
                    print("ActionCandidates: ", action_candidates.shape)
